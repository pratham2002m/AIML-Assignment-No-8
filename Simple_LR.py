...
test = pd.read_csv('test_dataset1.csv')
...
def test_data() : 
    ...
    print("Mean square error (MSE) Score = ",mean_squared_error(test_y, predicted_test_y))
    print("Mean square error (MSE) Score = ",MSE(test_y, predicted_test_y))
    print("R2 Score = ",r2_score(test_y, predicted_test_y))
    print("R2 Score = ",R2_Score(test_y, predicted_test_y))
